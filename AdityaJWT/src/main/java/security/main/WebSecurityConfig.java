...
import security.services.UserDetailService;
...
//this is a transactionsl class which loads(get data of the user if he exists or not in db) the User with Username from DB.
  @Autowired
